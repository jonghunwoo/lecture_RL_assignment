...
class JSSPLikeEnvironment:
    ...
    def get_state(self) -> Tuple[int, ...]:
        # TODO: compare this compact state with at least one richer feature design.
    ...
    def action_mask(self) -> List[bool]:
        # Action is selecting a job whose next operation is available.
    ...
    def compute_reward(self, previous_makespan: int, new_makespan: int) -> float:
        # TODO: compare this with a shaped reward that includes workload leveling.
